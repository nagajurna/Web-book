...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(3), __webpack_require__(1), __webpack_require__(25), __webpack_require__(9), __webpack_require__(26), __webpack_require__(27), __webpack_require__(10), __webpack_require__(5), __webpack_require__(28), __webpack_require__(11), __webpack_require__(12), __webpack_require__(29), __webpack_require__(13), __webpack_require__(30)], __WEBPACK_AMD_DEFINE_RESULT__ = function (arr, document, getProto, _slice, concat, push, indexOf, class2type, toString, hasOwn, fnToString, ObjectFunctionString, support, DOMEval) {
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(7)], __WEBPACK_AMD_DEFINE_RESULT__ = function (pnum) {
	"use strict";
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(0), __webpack_require__(1), __webpack_require__(15), __webpack_require__(13)], __WEBPACK_AMD_DEFINE_RESULT__ = function (jQuery, document, documentElement, support) {
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(0), __webpack_require__(6), __webpack_require__(17), __webpack_require__(18), __webpack_require__(8), __webpack_require__(4) // Get jQuery.contains
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(0), __webpack_require__(1), __webpack_require__(35), __webpack_require__(36)], __WEBPACK_AMD_DEFINE_RESULT__ = function (jQuery, document, rsingleTag) {
				...
				if ('webkitColumnWidth' in document.body.style || 'mozColumnWidth' in document.body.style || 'columnWidth' in document.body.style) {
					...
					if (_this._tableInfos === undefined || _this._tableInfos.totalPages === null) {
						...
						for (var _i = 0; _i < sections.length; _i++) {
							...
							_this._toc_sections_page_start.push(item); //all sections (including nested sections)
						}

						_this._elPageNumbers = _this._bookContainer.querySelectorAll('[data-wb-element-page-number]');
						for (var _i2 = 0; _i2 < _this._elPageNumbers.length; _i2++) {
							...
							var el = _this._text.querySelector('#' + id);

							if (!el.className.match(/wb-section/)) {
								//non sections refs
								_item.id = id;
								_item.page_start = _this.elementPageNumber(id);
								_this._toc_sections_page_start.push(_item);
							}
						}
					} else {
					...
					var _loop = function _loop(_i3) {
						var id = _this._elPageNumbers[_i3].getAttribute('data-wb-element-page-number');
						var pageNumber = _this._toc_sections_page_start.filter(function (o) {
							return o.id === id;
						})[0].page_start;

						if (pageNumber < 1) {
							_this._elPageNumbers[_i3].innerHTML = "";
						} else if (_this._elPageNumbers[_i3].innerHTML != pageNumber) {
							_this._elPageNumbers[_i3].innerHTML = pageNumber;
						}
					};

					for (var _i3 = 0; _i3 < _this._elPageNumbers.length; _i3++) {
						_loop(_i3);
					}
			...
			if (currentSection) {
				for (var _i4 = 0; _i4 < this._tocs.length; _i4++) {
					...
					for (var j = 0; j < links.length; j++) {
						var _id = currentSection.getAttribute('data-wb-active-section') ? currentSection.getAttribute('data-wb-active-section') : currentSection.id;
						if (links[j].getAttribute('href').replace(/^#/, '') === _id) {
		...
		value: function refresh() {
			...
			if (this.col === false) {
				...
				for (var _i7 = 0; _i7 < this._currentPages.length; _i7++) {
					...
					} else if (this._currentPages[_i7].innerHTML !== _pageNumber) {
						this._currentPages[_i7].innerHTML = _pageNumber;
					}
				}
				...
				for (var _i8 = 0; _i8 < this._currentTotalPages.length; _i8++) {
					...
					} else if (this._currentTotalPages[_i8].innerHTML !== _pageNumber2 + "/" + this.pages_total) {
						this._currentTotalPages[_i8].innerHTML = _pageNumber2 + "/" + this.pages_total;
					}
				}
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(0), __webpack_require__(14), __webpack_require__(1), __webpack_require__(15), __webpack_require__(6), __webpack_require__(16), __webpack_require__(21), __webpack_require__(8), __webpack_require__(34), __webpack_require__(19), __webpack_require__(38), __webpack_require__(4) // contains
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(0), __webpack_require__(33)], __WEBPACK_AMD_DEFINE_RESULT__ = function (jQuery, Sizzle) {
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(0), __webpack_require__(10), __webpack_require__(37), __webpack_require__(4)], __WEBPACK_AMD_DEFINE_RESULT__ = function (jQuery, indexOf, rneedsContext) {
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(0), __webpack_require__(7), __webpack_require__(14), __webpack_require__(17), __webpack_require__(1), __webpack_require__(20), __webpack_require__(6), __webpack_require__(39), __webpack_require__(18), __webpack_require__(40), __webpack_require__(16), __webpack_require__(41), __webpack_require__(21), __webpack_require__(8), __webpack_require__(19), __webpack_require__(42), __webpack_require__(4) // contains
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(0), __webpack_require__(20)], __WEBPACK_AMD_DEFINE_RESULT__ = function (jQuery, rcssNum) {
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(0), __webpack_require__(1), __webpack_require__(43), __webpack_require__(44)], __WEBPACK_AMD_DEFINE_RESULT__ = function (jQuery, document) {
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(0), __webpack_require__(9), __webpack_require__(45)], __WEBPACK_AMD_DEFINE_RESULT__ = function (jQuery, slice) {
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(0), __webpack_require__(46)], __WEBPACK_AMD_DEFINE_RESULT__ = function (jQuery, rnothtmlwhite) {
